...
public class AutenticacaoIT {
    ...
    @Test
    public void autenticao_ComCredenciaisValidas_RetornarTokenComStatus200() {
    ...
    @Test
    public void autenticao_ComCredenciaisInvalidas_RetornarErrorMessageStatus400() {
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("ana@email.com","123451"))
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void autenticao_ComUsernameInvalido_RetornarErrorMessageStatus422() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void autenticao_ComPasswordInvalido_RetornarErrorMessageStatus422() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
