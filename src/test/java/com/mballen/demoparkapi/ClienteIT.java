...
public class ClienteIT {
    ...
    public void criarCliente_ComDadosValidos_RetornarClienteComStatus201() {
        ClienteResponseDto responseBody = testClient
                ...
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "55278518030"))
                .exchange()
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("55278518030");
    }
    ...
    public void criarCliente_ComCpfJaCadastrado_RetornarErrorMessageComStatus409() {
        ErrorMessage responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "47854723087"))
                .exchange()
    ...
    public void criarCliente_ComDadosInvalidos_RetornarErrorMessageComStatus422() {
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("Bobb", "552.785.180-30"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void criarCliente_ComUsuarioNaoPermitido_RetornarErrorMessageComStatus403() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/clientes")
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "elias@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "55278518030"))
                .exchange()
    ...
    @Test
    public void buscarCliente_ComIdInexistentePeloCliente_RetornarClienteComStatus404() {
        ErrorMessage responseBody = testClient
                .get()
    ...
    @Test
    public void buscarCliente_ComIdExistentePeloCliente_RetornarClienteComStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/clientes/10")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "luana@email.com", "123456"))
                .exchange()
    ...
    @Test
    public void buscarClientes_ComPaginacaoPeloCliente_RetornarClienteComStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/clientes")
    ...
    public void buscarClientes_ComDadosDoTokenDeCliente_RetornarClienteComStatus200() {
        ClienteResponseDto responseBody = testClient
                ...
                .returnResult().getResponseBody();
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("47854723087");
        org.assertj.core.api.Assertions.assertThat(responseBody.getNome()).isEqualTo("Ana Brasil");
        org.assertj.core.api.Assertions.assertThat(responseBody.getId()).isEqualTo(20);
    }

    @Test
    public void buscarClientes_ComDadosDoTokenDeAdministrador_RetornarErrorMessageComStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/clientes/detalhes")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "elias@email.com", "123456"))
