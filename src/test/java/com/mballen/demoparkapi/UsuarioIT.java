...
public class UsuarioIT {
    ...
    public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("elias@email.com");
    ...
    public void editarSenha_ComCamposInvalidos_RetornarErrorMessageComStatus422() {
        ...
        responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "elias@email.com", "123456"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("12345", "10101", "10101"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "elias@email.com", "123456"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("1234567", "10101010", "10101010"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void editarSenha_ComSenhasInvalidas_RetornarErrorMessageComStatus400() {
        ErrorMessage responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "elias@email.com", "123456"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("123456", "123456", "101010"))
                .exchange()
        ...
        responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "elias@email.com", "123456"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("101010", "101010", "101010"))
                .exchange()
                .expectStatus().isEqualTo(400)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void listarTodosOsUsuarios_RetornarListaDeUsuariosComStatus200() {
